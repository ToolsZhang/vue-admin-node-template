  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户编号" align="center" key="_id" prop="_id" v-if="columns[0].visible" />
          ...
          <el-table-column label="部门" align="center" prop="dept" :formatter="deptFormat" v-if="columns[3].visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form._id == undefined" label="用户名称" prop="user_name">
              <el-input v-model="form.user_name" placeholder="请输入用户名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form._id == undefined" label="用户密码" prop="password">
...
export default {
  ...
  methods: {
    ...
    /** 查询所有权限 */
    getRoles(){
      listRole({limit: 1000,status: '0'}).then(response => {
        this.roleOptions = response.docs;
      });
    },
    /** 查询所有部门 */
    getDepts(){
      tableDept({limit: 1000}).then(response => {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.user_name + '"用户吗?', "警告", {
          ...
          return changeUserStatus(row._id, row.status);
        }).then(() => {
    ...
    handleResetPwd(row) {
      this.$prompt('请输入"' + row.user_name + '"的新密码', "提示", {
        ...
        cancelButtonText: "取消"
          ...
          resetUserPwd(row._id, value).then(response => {
