<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="字典编号" align="center" prop="_id" />
      <el-table-column label="字典名称" align="center" prop="dict_name" :show-overflow-tooltip="true" />
      <el-table-column label="字典类型" align="center" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          <router-link :to="'/dict/type/data/' + scope.row._id" class="link-type">
          <!-- <router-link :to="'/dict/type/data'" class="link-type"> -->
...
<script>
import { listType, getType, getDicts, delType, addType, updateType, exportType, clearCache } from "@/api/system/dict/type";
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const dictIds = row._id || this.ids;
